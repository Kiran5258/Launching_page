      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-white/5">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-slate-900 border-b border-white/5 px-4 pt-2 pb-4 space-y-1">
            <a href="#home" className="block px-3 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg">Home</a>
            <a href="#features" className="block px-3 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg">Features</a>
            <a href="#services" className="block px-3 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg">Services</a>
            <a href="#how-it-works" className="block px-3 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg">How It Works</a>
            <a href="#download" className="block px-3 py-2 text-indigo-400 font-medium">Download App</a>
          </div>
        )}
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              ...
              <a href="mailto:hello@gigiman.com" className="text-slate-300 hover:text-cyan-400 transition-colors">hello@gigiman.com</a>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Pro Guidelines</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-indigo-500 hover:text-white transition-all">
                {/* Social icons, just generic for now */}
